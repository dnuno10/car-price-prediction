...
#ifndef LOADMODEL_SWIFT_H
#define LOADMODEL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="loadmodel",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC9loadmodel11AppDelegate")
...
SWIFT_CLASS("_TtC9loadmodel17MainFlutterWindow")
